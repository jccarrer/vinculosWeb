...
new jBox('Modal', {
  ...
  content: '<img id="grafico" style="position: relative;height:auto;" src="images/game/imagen_de_ventana_emergente2.jpg" alt=""> <br>'+
          '<div id="ventana_body" style="line-height: 30px;">'+
                ...
                ' '+
          '</div>'+
          '<div id="tutorial_text" style="float:left;"><a href="#">TUTORIAL</a></div><div id="jugar_text" style="float: right; "><a href="#">JUGAR</a></div>'
});
...
new jBox('Modal', {
  ...
  height: 450,
  // title: 'I\'m a basic jBox modal window',
  content: '<img id="grafico" style="position: relative;height:auto;" src="images/game/imagen_de_ventana2_emergente.jpg" alt=""> <br>'+
           '<div id="ventana_body" style="line-height: 30px;">'+
